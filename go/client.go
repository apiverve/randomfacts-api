// Package randomfacts provides a Go client for the Random Facts API.
//
// For more information, visit: https://apiverve.com/marketplace/randomfacts?utm_source=go&utm_medium=readme
package randomfacts
...
const (
	baseURL        = "https://api.apiverve.com/v1/randomfacts"
	defaultTimeout = 30 * time.Second
)

// Client is the Random Facts API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Random Facts API client.
...
// Execute makes a request to the Random Facts API.
