...
```gradle
dependencies {
    implementation 'com.github.apiverve:randomfacts-api:1.1.14'
}
```
...
```java
import com.apiverve.randomfacts.RandomFactsAPIClient;
import com.apiverve.randomfacts.APIResponse;
import com.apiverve.randomfacts.APIException;

// Initialize the client
RandomFactsAPIClient client = new RandomFactsAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/randomfacts](https://docs.apiverve.com/ref/randomfacts)
...
- **Documentation:** [https://docs.apiverve.com/ref/randomfacts](https://docs.apiverve.com/ref/randomfacts)
- **Issues:** [GitHub Issues](https://github.com/apiverve/randomfacts-api/issues)
